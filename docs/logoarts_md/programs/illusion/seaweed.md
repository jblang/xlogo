...
The shapes are all the same, drawn by procedure tile 'Seaweed'. They appear to 
wave because of their alternating orientation and color. Using a move 
of 14.5 from the tile centre ensures the tile is positioned identically for 
each 90 degree orientation.
