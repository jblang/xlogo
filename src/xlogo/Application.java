...
public class Application extends JFrame {
    ...
    private final JMenuItem jMenuFileNouveau = new JMenuItem();
    private final JMenuItem jMenuFileEnregistrer = new JMenuItem();
    private final JMenuItem jMenuFileEnregistrer_sous = new JMenuItem();
    private final JMenuItem jMenuFileOuvrir = new JMenuItem();
    private final JMenuItem jMenuFileQuitter = new JMenuItem();
    private final JMenu jMenuCapture = new JMenu();
    private final JMenuItem jMenuImageCopy = new JMenuItem();
    private final JMenuItem jMenuImageSave = new JMenuItem();
    private final JMenuItem jMenuImagePrint = new JMenuItem();
    private final JMenu jMenuZoneTexte = new JMenu();
    private final JMenuItem jMenuZoneTexteItem = new JMenuItem();
    private final JMenu jMenuEdition = new JMenu();
    private final JMenuItem jMenuEditionCopier = new JMenuItem();
    private final JMenuItem jMenuEditionColler = new JMenuItem();
    private final JMenuItem jMenuEditionCouper = new JMenuItem();
    private final JMenuItem jMenuEditionSelect = new JMenuItem();
    private final JMenu jMenuOptions = new JMenu();
    private final JMenuItem jMenuOptionsCouleurCrayon = new JMenuItem();
    private final JMenuItem jMenuOptionsCouleurFond = new JMenuItem();
    private final JMenuItem jMenuOptionsDemarrage = new JMenuItem();
    ...
    protected void genere_primitive() {
        ...
        for (int i = 0; i < compteur; i++) {
            ...
            if (Config.path.get(i).equals("#####"))
                editeur.setAffichable(true); //on a terminé avec les fichiers de démarrage
            else {
                try {
