...
public class Demarrage extends JDialog implements ActionListener{
	...
	private JPanel p_executer=new JPanel();
	private BorderLayout borderexec = new BorderLayout();
	private JLabel exec=new JLabel(" "+Logo.messages.getString("procedure_demarrage")+" ");
	private JTextField proc_demarrage=new JTextField();
